const ExperienceSection = () => {
  return (
    <div className="w-full max-w-6xl mx-auto mb-16 bg-[#1a1a1a] rounded-xl p-8 lg:p-12 border border-gray-800">
      {/* Main Heading */}
      <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">
        The AI Boyfriend Chat Experience
      </h2>
      ...
      <p className="text-gray-400 text-base lg:text-lg leading-relaxed mb-12">
        Similar to our <span className="text-pink-500">AI Girlfriend</span> experience, our AI Boyfriend advanced model brings AI companionship to life and provides engaging interactions tailored to 
        your personality and preferences. Using cutting-edge technology, the AI BF adapts to your style, interests, and emotions, making every conversation feel 
        natural and meaningful. And in case you can't find any of our characters to be of your liking, you can always use our <span className="text-pink-500">AI Boyfriend Generator</span>.
      </p>

      {/* Start Your AI BF Journey Section */}
      <h3 className="text-2xl lg:text-3xl font-bold text-white mb-6">
        Start Your AI BF Journey
      </h3>

      <p className="text-gray-400 text-base lg:text-lg leading-relaxed mb-6">
        Getting started with an AI boyfriend is simple and seamless. Whether you're new to AI companions or a seasoned user, our platform is designed to be 
      ...
      <ul className="space-y-4 mb-12">
        ...
        <li className="text-gray-300">
          <span className="font-bold text-white">Start Chatting</span> – Engage in conversations anytime, anywhere. Your AI boyfriend learns from your interactions, making every chat feel more 
      ...
      <h3 className="text-2xl lg:text-3xl font-bold text-white mb-6">
        A Safe Environment for an Encrypted AI Boyfriend Chat
      </h3>
